...
graph_status_bar <- anti_trans_bills_year_status %>% ggplot(aes(x = year, y = n, fill = Status)) + geom_bar(stat = "identity", position = "dodge")
graph_status_line <- anti_trans_bills_year_status %>% ggplot(aes(x = year, y = n, color = Status)) + geom_line()
...
#Create graphs
graph_type_count <- anti_trans_bills_year_type %>% ggplot(aes(x = year, y = n, fill = `Bill Type`)) + geom_bar(stat = "Identity")
graph_type_percent <- anti_trans_bills_year_type %>% ggplot(aes(x = year, y = n, fill = `Bill Type`)) + geom_col(position = "fill")
