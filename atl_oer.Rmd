...
In some legislation that reques changes to multiple sections, occassionally preamble is repeated at the start to each section. See the example below from Florida:
___
