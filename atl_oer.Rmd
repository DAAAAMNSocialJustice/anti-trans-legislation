...
write.csv(ltext_vec, file = paste0("bill_",i), row.names = FALSE, col.names = TRUE)
```
...
The first number is rows (226) and the second is columns (3). This means that our word vector contains 226 words & 3 columsn - the word, the absolute frequency or count, and the relative frequency or probability of occurance. 
...
ggplot2 needs to use the original dataframe, not the top 20
