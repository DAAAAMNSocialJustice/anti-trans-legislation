...
```{r}
# we are going to do the first anti-trans bill - an Arkansas bill that passed and was called "The Given Name Act" which addresses pronoun use in schools & is named the same as the Heritage template legislation
i = 1
billname = paste0("probill_",i)
ltext<-bills$text[i]
ltext
```
